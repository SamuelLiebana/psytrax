...
This roadmap turns the Neuroinformatics Unit feedback into concrete work items.
It borrows the broad site shape from
[`movement`](https://movement.neuroinformatics.dev/latest/index.html) and the
Sphinx project pattern from the
[Neuroinformatics Unit python-cookiecutter](https://python-cookiecutter.neuroinformatics.dev/project_setup.html).

| Area | Next step | Status |
| --- | --- | --- |
| Narrative documentation | Start with an experimentalist-first tutorial for a new student in Ann's lab | Started |
| Good examples | Convert existing scripts into a curated example gallery with real datasets | Planned |
| Documentation structure | Use [Diataxis](https://diataxis.fr/): tutorials, how-to/user guide, reference, explanation | Started |
...
1. Build and publish the first documentation site.
